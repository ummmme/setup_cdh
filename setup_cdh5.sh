...
# 请勿修改以下内容：
# --------------------------------------------------------------------
ORACLE_JDK_PACKAGE="packages/jdk-8u181-linux-x64.tar.gz";

MYSQL_JDBC_DRIVER="packages/mysql-connector-java-5.1.47.tar.gz";

CLOUDERA_MANAGER_DEAMON="packages/cloudera-manager-daemons-5.15.1-1.cm5151.p0.3.el7.x86_64.rpm";

CLOUDERA_MANAGER_SERVER="packages/cloudera-manager-server-5.15.1-1.cm5151.p0.3.el7.x86_64.rpm";

CLOUDERA_MANAGER_AGENT="packages/cloudera-manager-agent-5.15.1-1.cm5151.p0.3.el7.x86_64.rpm";

CDH_PARCEL="packages/CDH-5.15.1-1.cdh5.15.1.p0.4-el7.parcel";

CDH_SHA="packages/CDH-5.15.1-1.cdh5.15.1.p0.4-el7.parcel.sha1";

CDH_MANIFEST_JSON="packages/manifest.json";
#--------------------------------------------------------------------
...
ensureVariable() {
    ...
    echo "checking Cloudera Manager packages...";
